...
var ProjectWhere = struct {
	...
	UserID:      whereHelperstring{field: "`projects`.`user_id`"},
...
var (
	projectAllColumns            = []string{"id", "user_id", "title", "description", "created_at", "updated_at"}
	projectColumnsWithoutDefault = []string{"user_id", "title", "description"}
...
func (q projectQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Project, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: failed to execute a one query for projects")
	}
...
func (q projectQuery) All(ctx context.Context, exec boil.ContextExecutor) (ProjectSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "model: failed to assign all query results to Project slice")
	}
...
func (q projectQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to count projects rows")
	}
...
func (q projectQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "model: failed to check if projects exists")
	}
...
func (o *Project) ProjectsLabels(mods ...qm.QueryMod) projectsLabelQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`projects_labels`.`project_id`=?", o.ID),
	)
...
func (o *Project) ProjectsTodos(mods ...qm.QueryMod) projectsTodoQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("`projects_todos`.`project_id`=?", o.ID),
	)
...
func (projectL) LoadProjectsLabels(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProject interface{}, mods queries.Applicator) error {
	var slice []*Project
	var object *Project
	...
	query := NewQuery(qm.From(`projects_labels`), qm.WhereIn(`projects_labels.project_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (projectL) LoadProjectsTodos(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProject interface{}, mods queries.Applicator) error {
	var slice []*Project
	var object *Project
	...
	query := NewQuery(qm.From(`projects_todos`), qm.WhereIn(`projects_todos.project_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (projectL) LoadUsersProjects(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProject interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(qm.From(`users_projects`), qm.WhereIn(`users_projects.project_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Project) AddProjectsLabels(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ProjectsLabel) error {
	var err error
...
// Sets related.R.Project appropriately.
func (o *Project) AddProjectsTodos(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ProjectsTodo) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.ProjectID = o.ID
...
func FindProject(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Project, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: unable to select from projects")
	}
...
func (o *Project) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("model: no projects provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to insert into projects")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to populate default values for projects")
	}
...
func (o *Project) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("model: unable to update projects, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update projects row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by update for projects")
	}
...
func (q projectQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all for projects")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected for projects")
	}
...
func (o ProjectSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all in project slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected all in update all project")
	}
	return rowsAff, nil
}
...
func (o *Project) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("model: no projects provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("model: unable to upsert projects, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to upsert for projects")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to retrieve unique values for projects")
	}
...
func (o *Project) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("model: no Project provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete from projects")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by delete for projects")
	}
...
func (q projectQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("model: no projectQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from projects")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by deleteall for projects")
	}
...
func (o ProjectSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from project slice")
	}
...
func (o *ProjectSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to reload all in ProjectSlice")
	}
...
func ProjectExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "model: unable to check if projects exists")
	}
