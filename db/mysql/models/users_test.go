...
var (
	userDBTypes = map[string]string{`ID`: `varchar`, `UserID`: `varchar`, `Email`: `varchar`, `Password`: `varchar`, `Name`: `varchar`, `Thumbnail`: `varchar`, `CreatedAt`: `datetime`, `UpdatedAt`: `datetime`}
	_           = bytes.MinRead
)
