...
var UserWhere = struct {
	...
	Thumbnail: whereHelperstring{field: "`users`.`thumbnail`"},
...
var (
	userAllColumns            = []string{"id", "user_id", "email", "password", "name", "thumbnail", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"id", "user_id", "email", "password", "name", "thumbnail"}
